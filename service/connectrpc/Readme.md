# Dapr ConnectRPC Service SDK for Go

Start by importing Dapr Go `service/connectrpc` package:

```go
daprd "github.com/dapr/go-sdk/service/connectrpc"
```

## Creating and Starting Service

To create a ConnectRPC Dapr service, first, create a Dapr callback instance with a specific address:
