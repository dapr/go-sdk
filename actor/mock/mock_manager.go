...
func (m *MockActorManager) DeactivateActor(actorID string) error.ActorError {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeactivateActor", actorID)
	ret0, _ := ret[0].(error.ActorError)
	return ret0
}
...
func (m *MockActorManager) InvokeMethod(actorID, methodName string, request []byte) ([]byte, error.ActorError) {
	m.ctrl.T.Helper()
...
func (m *MockActorManager) InvokeReminder(actorID, reminderName string, params []byte) error.ActorError {
	m.ctrl.T.Helper()
...
func (m *MockActorManager) InvokeTimer(actorID, timerName string, params []byte) error.ActorError {
	m.ctrl.T.Helper()
...
// DeactivateActor mocks base method.
func (m *MockActorManagerContext) DeactivateActor(ctx context.Context, actorID string) error.ActorError {
	m.ctrl.T.Helper()
...
// InvokeMethod mocks base method.
func (m *MockActorManagerContext) InvokeMethod(ctx context.Context, actorID, methodName string, request []byte) ([]byte, error.ActorError) {
	m.ctrl.T.Helper()
...
// InvokeReminder mocks base method.
func (m *MockActorManagerContext) InvokeReminder(ctx context.Context, actorID, reminderName string, params []byte) error.ActorError {
	m.ctrl.T.Helper()
...
// InvokeTimer mocks base method.
func (m *MockActorManagerContext) InvokeTimer(ctx context.Context, actorID, timerName string, params []byte) error.ActorError {
	m.ctrl.T.Helper()
